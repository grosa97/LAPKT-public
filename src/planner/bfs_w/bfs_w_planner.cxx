...
BFS_W_Planner::BFS_W_Planner()
        : STRIPS_Interface(), m_log_filename("bfs_w.log"), m_plan_filename("plan.ipc"), m_memory_budget(3900)
        {
        }

BFS_W_Planner::BFS_W_Planner(std::string domain_file, std::string instance_file)
        : STRIPS_Interface(domain_file, instance_file), m_iw_bound(1), m_log_filename("bfs_w.log"), m_plan_filename("plan.ipc"), m_memory_budget(3900)
        {
        }
BFS_W_Planner::BFS_W_Planner(std::string domain_file, std::string instance_file,
...
void BFS_W_Planner::setup(bool gen_match_tree)
{
...
float BFS_W_Planner::do_search_single_goal(Search_Engine &engine,
...
template <typename Search_Engine>
float BFS_W_Planner::do_search(Search_Engine &engine, aptk::STRIPS_Problem &plan_prob,
