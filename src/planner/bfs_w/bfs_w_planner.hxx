#ifndef __BFS_W_PLANNER__
#define __BFS_W_PLANNER__
...
//---- BFS_W_Planner Class -----------------------------------------------------//
class BFS_W_Planner : public STRIPS_Interface
{
public:
        ...
        typedef Novelty<Fwd_Search_Problem, Search_Node> H_Novelty;
        typedef AT_BFS_SQ_SH< Fwd_Search_Problem, H_Novelty, BFS_Open_List > BFS_W;

        BFS_W_Planner();
        BFS_W_Planner(std::string, std::string);
        BFS_W_Planner(std::string, std::string, unsigned,
                   std::string, std::string);
        virtual ~BFS_W_Planner();
