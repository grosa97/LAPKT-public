...
//TESTING
typedef Custom_Priority_Queue<Tie_Breaking_Algorithm_2h_ignore_costs,Search_Node_2h> BFS_Open_List_2h;
...
// typedef GS_BFCS_3H<Fwd_Search_Problem, H_Novel_Count_Partition, H_Lmcount_Fwd, H_Novel_Fwd_3h, H_Add_Rp_Fwd, BFS_Open_List_3h> basic_BFCS;
typedef GS_BFCS_3H<Fwd_Search_Problem, H_Novel_Count_Partition, H_Lmcount_Fwd, H_Novel_Fwd_3h, H_Add_Rp_Fwd, Testing_Open_List> basic_BFCS_pruned_open;
// typedef BFWS_2H<Fwd_Search_Problem, H_Novel_Fwd_2h, H_Lmcount_Fwd, H_Add_Rp_Fwd, Testing_Open_List_2h> k_BFWS;//uses pruned open
